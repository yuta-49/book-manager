...
import com.book.manager.infrastructure.database.record.UserDynamicSqlSupport.User
import com.book.manager.infrastructure.database.record.UserDynamicSqlSupport.User.email
import com.book.manager.infrastructure.database.record.UserDynamicSqlSupport.User.id
import com.book.manager.infrastructure.database.record.UserDynamicSqlSupport.User.name
import com.book.manager.infrastructure.database.record.UserDynamicSqlSupport.User.password
import com.book.manager.infrastructure.database.record.UserDynamicSqlSupport.User.roleType
